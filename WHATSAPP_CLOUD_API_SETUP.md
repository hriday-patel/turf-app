...
```bash
curl -X POST 'https://<your-vercel-domain>/api/whatsapp/send-message' \
...
```bash
--dart-define=API_BASE_URL=https://<your-vercel-domain>/api
```

If not provided, it defaults to:

- `https://turf-app-lyart.vercel.app/api`
